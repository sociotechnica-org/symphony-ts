...
export function renderThirdPartyWorkflowTemplate(
  ...
  return [
    ...
    "   When the workflow uses a plan-review station, follow `config.tracker.planReview` for the exact handoff markers, metadata labels, and reviewer reply template instead of inventing your own strings.",
